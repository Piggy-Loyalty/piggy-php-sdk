...
class LoyaltyTokenResourceTest extends OAuthTestCase
{
    ...
    public function it_returns_a_credit_based_loyalty_token_url()
    {
        ...
        $this->assertEquals(
            'https://customer.piggy.nl/l?version=v1&shop_id=15&credits=20&unique_id=my_unique_id&timestamp=1672931049&hash=a9d8163cfb19b0b46d6ded40c0817de11be48bbf', $loyaltyToken);
    }
